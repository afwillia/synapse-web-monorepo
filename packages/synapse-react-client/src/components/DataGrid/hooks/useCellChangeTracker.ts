 ...
 * - If the author sid resolves to a SERVICE replica (determined by the consumer
 *   via replicaUserMap), the caller should pass `SERVICE_SID_SENTINEL` or simply
 *   not include SERVICE replicas in the map — the indicator will be absent.
